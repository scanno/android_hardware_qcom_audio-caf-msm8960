...
#define HFP_DUAL_ASM_LOOPBACK 0
...
#if HFP_DUAL_ASM_LOOPBACK == 0
    [USECASE_AUDIO_HFP_SCO] = {I2S_HOSTLESS, ASM_TX_LOOPBACK},
    [USECASE_AUDIO_HFP_SCO_LINK] = {ASM_TX_LOOPBACK, HFP_PCM_RX},
    [USECASE_AUDIO_HFP_SCO_WB] = {I2S_HOSTLESS, ASM_TX_LOOPBACK},
    [USECASE_AUDIO_HFP_SCO_LINK_WB] = {ASM_TX_LOOPBACK, HFP_PCM_RX},
#else	// #if USE_AFE_LOOPBACK == 0
    [USECASE_AUDIO_HFP_SCO] = {ASM_RX_LOOPBACK, ASM_TX_LOOPBACK},
    [USECASE_AUDIO_HFP_SCO_LINK] = {ASM_TX_LOOPBACK, ASM_RX_LOOPBACK},
    [USECASE_AUDIO_HFP_SCO_WB] = {ASM_RX_LOOPBACK, ASM_TX_LOOPBACK},
    [USECASE_AUDIO_HFP_SCO_LINK_WB] = {ASM_TX_LOOPBACK, ASM_RX_LOOPBACK},
#endif	// #if USE_AFE_LOOPBACK == 0
